...
@once
    <style>
        ...
        .muni-checkbox { display:inline-flex; align-items:center; justify-content:center; width:18px; height:18px; border:1px solid var(--muni-border); border-radius:var(--muni-radius-sm); background:var(--muni-surface); color:var(--muni-on-accent); transition:background var(--muni-dur) var(--muni-ease),border-color var(--muni-dur) var(--muni-ease); }
